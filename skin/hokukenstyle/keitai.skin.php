...
$navi[] = '<a href="'.$script.'?FrontPage'.'" '.$accesskey.'="1">1.トップ</a>';
$navi[] = '<a href="'.$script.'?SiteNavigator'.'" '.$accesskey.'="2">2.ナビ</a>';
$navi[] = '<a href="' . $script . '?' . rawurlencode($menubar) . '" ' . $accesskey . '="3">3.メニュー</a>';
