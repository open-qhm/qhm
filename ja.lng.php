...
$_msg_notfoundpage_title = '指定されたページは存在しません';
$_msg_notfoundpage = '<p>現在、指定されたページは存在しません。<br />お手数ですが、<a href="$1">ここ</a>をクリックしてトップにお戻り下さい。</p>';
...
$_LANG['skin']['menuadmin']    = 'メニュー管理';	// Menu Edite (hokuken.com original)
