...
function lastscript() {
  ...
  if (parent.document.getElementById("msg").setSelectionRange) {
    parentMsgSelectionStart = parent.document.getElementById("msg")
      .selectionStart;
  }
}
